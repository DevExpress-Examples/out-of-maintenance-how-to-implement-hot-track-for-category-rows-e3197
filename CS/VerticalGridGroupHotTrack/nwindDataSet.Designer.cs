...
namespace VerticalGridGroupHotTrack {
    ...
    public partial class nwindDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public ProductsRow AddProductsRow(string ProductName, int SupplierID, int CategoryID, decimal UnitPrice, short UnitsOnOrder) {
...
namespace VerticalGridGroupHotTrack.nwindDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Products` WHERE ((`ProductID` = ?) AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `SupplierID` IS NULL) OR (`SupplierID` = ?)) AND ((? = 1 AND `CategoryID` IS NULL) OR (`CategoryID` = ?)) AND ((? = 1 AND `UnitPrice` IS NULL) OR (`UnitPrice` = ?)) AND ((? = 1 AND `UnitsOnOrder` IS NULL) OR (`UnitsOnOrder` = ?)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Products` SET `ProductName` = ?, `SupplierID` = ?, `CategoryID` = ?, `UnitPrice` = ?, `UnitsOnOrder` = ? WHERE ((`ProductID` = ?) AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `SupplierID` IS NULL) OR (`SupplierID` = ?)) AND ((? = 1 AND `CategoryID` IS NULL) OR (`CategoryID` = ?)) AND ((? = 1 AND `UnitPrice` IS NULL) OR (`UnitPrice` = ?)) AND ((? = 1 AND `UnitsOnOrder` IS NULL) OR (`UnitsOnOrder` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::VerticalGridGroupHotTrack.Properties.Settings.Default.nwindConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductID, ProductName, SupplierID, CategoryID, UnitPrice, UnitsOnOrder FR" +
                "OM Products";
        ...
        public virtual int Delete(int Original_ProductID, string Original_ProductName, global::System.Nullable<int> Original_SupplierID, global::System.Nullable<int> Original_CategoryID, global::System.Nullable<decimal> Original_UnitPrice, global::System.Nullable<short> Original_UnitsOnOrder) {
            ...
            if ((Original_UnitsOnOrder.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[10].Value = ((short)(Original_UnitsOnOrder.Value));
            }
            else {
        ...
        public virtual int Update(string ProductName, global::System.Nullable<int> SupplierID, global::System.Nullable<int> CategoryID, global::System.Nullable<decimal> UnitPrice, global::System.Nullable<short> UnitsOnOrder, int Original_ProductID, string Original_ProductName, global::System.Nullable<int> Original_SupplierID, global::System.Nullable<int> Original_CategoryID, global::System.Nullable<decimal> Original_UnitPrice, global::System.Nullable<short> Original_UnitsOnOrder) {
            if ((ProductName == null)) {
            ...
            if ((UnitsOnOrder.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[4].Value = ((short)(UnitsOnOrder.Value));
            }
            else {
            ...
            if ((Original_UnitsOnOrder.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[15].Value = ((short)(Original_UnitsOnOrder.Value));
            }
            else {
