...
Partial Public Class nwindDataSet
    ...
    Partial Public Class ProductsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddProductsRow(ByVal ProductName As String, ByVal SupplierID As Integer, ByVal CategoryID As Integer, ByVal UnitPrice As Decimal, ByVal UnitsOnOrder As Short) As ProductsRow
            Dim rowProductsRow As ProductsRow = CType(Me.NewRow,ProductsRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, ProductName, SupplierID, CategoryID, UnitPrice, UnitsOnOrder}
    ...
    Partial Public Class ProductsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Products` WHERE ((`ProductID` = ?) AND ((? = 1 AND `ProductName` IS "& _ 
                ...
                "= 1 AND `UnitPrice` IS NULL) OR (`UnitPrice` = ?)) AND ((? = 1 AND `UnitsOnOrder"& _ 
                "` IS NULL) OR (`UnitsOnOrder` = ?)))"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Products` SET `ProductName` = ?, `SupplierID` = ?, `CategoryID` = ?, `Uni"& _ 
                "tPrice` = ?, `UnitsOnOrder` = ? WHERE ((`ProductID` = ?) AND ((? = 1 AND `Produc"& _ 
                "tName` IS NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `SupplierID` IS NULL) OR"& _ 
                " (`SupplierID` = ?)) AND ((? = 1 AND `CategoryID` IS NULL) OR (`CategoryID` = ?)"& _ 
                ") AND ((? = 1 AND `UnitPrice` IS NULL) OR (`UnitPrice` = ?)) AND ((? = 1 AND `Un"& _ 
                "itsOnOrder` IS NULL) OR (`UnitsOnOrder` = ?)))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ProductID, ProductName, SupplierID, CategoryID, UnitPrice, UnitsOnOrder FR"& _ 
                "OM Products"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_SupplierID As Global.System.Nullable(Of Integer), ByVal Original_CategoryID As Global.System.Nullable(Of Integer), ByVal Original_UnitPrice As Global.System.Nullable(Of Decimal), ByVal Original_UnitsOnOrder As Global.System.Nullable(Of Short)) As Integer
            ...
            If (Original_UnitsOnOrder.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(10).Value = CType(Original_UnitsOnOrder.Value,Short)
            Else
        ...
        Public Overloads Overridable Function Update(ByVal ProductName As String, ByVal SupplierID As Global.System.Nullable(Of Integer), ByVal CategoryID As Global.System.Nullable(Of Integer), ByVal UnitPrice As Global.System.Nullable(Of Decimal), ByVal UnitsOnOrder As Global.System.Nullable(Of Short), ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_SupplierID As Global.System.Nullable(Of Integer), ByVal Original_CategoryID As Global.System.Nullable(Of Integer), ByVal Original_UnitPrice As Global.System.Nullable(Of Decimal), ByVal Original_UnitsOnOrder As Global.System.Nullable(Of Short)) As Integer
            ...
            If (UnitsOnOrder.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(UnitsOnOrder.Value,Short)
            Else
            ...
            If (Original_SupplierID.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(9).Value = CType(Original_SupplierID.Value,Integer)
            Else
            ...
            If (Original_UnitsOnOrder.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(15).Value = CType(Original_UnitsOnOrder.Value,Short)
            Else
