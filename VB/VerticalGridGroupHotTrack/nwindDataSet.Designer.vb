...
Namespace VerticalGridGroupHotTrack
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class ProductsDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddProductsRow(ByVal ProductName As String, ByVal SupplierID As Integer, ByVal CategoryID As Integer, ByVal UnitPrice As Decimal, ByVal UnitsOnOrder As Short) As ProductsRow
				Dim rowProductsRow As ProductsRow = (CType(Me.NewRow(), ProductsRow))
				Dim columnValuesArray() As Object = { Nothing, ProductName, SupplierID, CategoryID, UnitPrice, UnitsOnOrder}
	...
	End Class
End Namespace
Namespace VerticalGridGroupHotTrack.nwindDataSetTableAdapters
	...
	Partial Public Class ProductsTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Products` WHERE ((`ProductID` = ?) AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `SupplierID` IS NULL) OR (`SupplierID` = ?)) AND ((? = 1 AND `CategoryID` IS NULL) OR (`CategoryID` = ?)) AND ((? = 1 AND `UnitPrice` IS NULL) OR (`UnitPrice` = ?)) AND ((? = 1 AND `UnitsOnOrder` IS NULL) OR (`UnitsOnOrder` = ?)))"
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE `Products` SET `ProductName` = ?, `SupplierID` = ?, `CategoryID` = ?, `UnitPrice` = ?, `UnitsOnOrder` = ? WHERE ((`ProductID` = ?) AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `SupplierID` IS NULL) OR (`SupplierID` = ?)) AND ((? = 1 AND `CategoryID` IS NULL) OR (`CategoryID` = ?)) AND ((? = 1 AND `UnitPrice` IS NULL) OR (`UnitPrice` = ?)) AND ((? = 1 AND `UnitsOnOrder` IS NULL) OR (`UnitsOnOrder` = ?)))"
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT ProductID, ProductName, SupplierID, CategoryID, UnitPrice, UnitsOnOrder FR" & "OM Products"
		...
		Public Overridable Function Delete(ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_SupplierID As Global.System.Nullable(Of Integer), ByVal Original_CategoryID As Global.System.Nullable(Of Integer), ByVal Original_UnitPrice As Global.System.Nullable(Of Decimal), ByVal Original_UnitsOnOrder As Global.System.Nullable(Of Short)) As Integer
			...
			If (Original_UnitsOnOrder.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(10).Value = (CShort(Fix(Original_UnitsOnOrder.Value)))
			Else
		...
		Public Overridable Function Update(ByVal ProductName As String, ByVal SupplierID As Global.System.Nullable(Of Integer), ByVal CategoryID As Global.System.Nullable(Of Integer), ByVal UnitPrice As Global.System.Nullable(Of Decimal), ByVal UnitsOnOrder As Global.System.Nullable(Of Short), ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_SupplierID As Global.System.Nullable(Of Integer), ByVal Original_CategoryID As Global.System.Nullable(Of Integer), ByVal Original_UnitPrice As Global.System.Nullable(Of Decimal), ByVal Original_UnitsOnOrder As Global.System.Nullable(Of Short)) As Integer
			...
			If (UnitsOnOrder.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(4).Value = (CShort(Fix(UnitsOnOrder.Value)))
			Else
			...
			If (Original_SupplierID.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(9).Value = (CInt(Fix(Original_SupplierID.Value)))
			Else
			...
			If (Original_CategoryID.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(11).Value = (CInt(Fix(Original_CategoryID.Value)))
			Else
			...
			If (Original_UnitsOnOrder.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(15).Value = (CShort(Fix(Original_UnitsOnOrder.Value)))
			Else
